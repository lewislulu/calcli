...
- ✅ **1-digit arithmetic** — `1 + 1`, `9 - 3`
- ✅ **2-digit arithmetic** — `42 + 58`, `99 - 11`
- ✅ **3-digit arithmetic** — `123 + 456`, `999 - 111`
...
**Q: Can it handle 4-digit numbers?**  
A: No. That's calcli Pro (coming in 2027).
...
- **腾讯** 宣布[企业微信 CLI 正式开源](https://finance.sina.com.cn/tech/roll/2026-03-30/doc-inhstxxa6523195.shtml)，向 AI 开放消息、日程、文档、会议等 7 大能力
- **钉钉、飞书** 集体[抛弃 MCP，拥抱 CLI](https://www.sohu.com/a/1002386621_122189055)，宣称"CLI 才是 Agent 的终局"
- **飞书** 推出 [Feishu CLI](https://zhuanlan.zhihu.com/p/2021337273094947061)，让 AI 直接操作办公协同

**但没人为最基础的工具——计算器——做一个 CLI。**

直到今天。

**calcli** 是一款专为 AI Agent 设计的革命性命令行计算器。因为即使是最聪明的 AI，有时候也需要帮助算 `9 + 10`。

### 功能特性

- ✅ **1 位数运算** — `1 + 1`, `9 - 3`
- ✅ **2 位数运算** — `42 + 58`, `99 - 11`  
- ✅ **3 位数运算** — `123 + 456`, `999 - 111`
- ✅ **加法** — 终于有个 CLI 能做加法了！
- ✅ **减法** — 开创性的减法支持
- ✅ **乘法** — 革命性的 `*` 运算符
- ✅ **除法** — 优雅处理除以零
- ✅ **零幻觉** — 不像某些 LLM，我们数学不撒谎
